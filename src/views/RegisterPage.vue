<template>
  <div id="signup-page" class="text-gray-700 antialiased">
        ...
        <div class="flex content-center items-center justify-center h-full">
          <div class="w-full lg:w-6/12 px-4">
            ...
            >
              <div class="rounded-t mb-0 px-6 py-6">
                <div class="text-center mb-3">
                  <h6 class="text-gray-500 text-sm font-bold">Sign up with</h6>
                </div>
            ...
            <div class="mt-6 flex justify-between">
              <div>
                <small class="text-gray-200 mr-1">Already have an account?</small>
                <router-link to="/login" class="text-pink-500">
                  <small>Sign in</small>
                </router-link>
              </div>
              <div>
